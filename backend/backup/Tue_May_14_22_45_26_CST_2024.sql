...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='借用';
...
INSERT INTO `course` VALUES (1,3,1,2,' 计算机网络','2023-2024-1','5','11','1-2',30,' 计算机科学与技术',' 21计机4班',0,'2024-05-14 22:01:06','2024-05-14 22:01:06',0);
...
INSERT INTO `maintain` VALUES (1,3,1,'投影仪损坏',NULL,0,'2024-05-14 20:46:03','2024-05-14 20:56:37',0);
...
CREATE TABLE `semester` (
  ...
  `status` int(11) NOT NULL COMMENT '当前学期状态，0否1是',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_delete` int(11) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`),
  UNIQUE KEY `semester` (`semester`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='学年';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `semester` VALUES (2,'2023-2024-2','20',0,'2024-04-24 00:01:15','2024-05-14 10:34:25',0),(3,'2023-2024-1','19',1,'2024-05-09 09:42:50','2024-05-14 10:42:38',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='节次';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `session` VALUES (1,'1-2','2024-05-14 21:56:35','2024-05-14 21:56:35',0),(2,'3-5','2024-05-14 21:56:35','2024-05-14 21:56:35',0),(3,'6-7','2024-05-14 21:56:35','2024-05-14 21:56:35',0),(4,'8-9','2024-05-14 21:56:35','2024-05-14 21:56:35',0),(5,'10-12','2024-05-14 21:56:35','2024-05-14 21:56:35',0),(6,'13-15','2024-05-14 21:56:35','2024-05-14 21:56:35',0);
...
-- Dump completed on 2024-05-14 22:45:26
